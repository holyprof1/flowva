...
function Onboarding() {
  ...
  return (
    <div className="onboarding-container animate__animated animate__fadeIn">
          ...
          <div className="step active">
            ...
            <div className="form-group">
              <label>
                ...
                {errors.role && <span className="warning">{errors.role}</span>}
              </label>
            ...
            <div className="form-group">
              <label>
                ...
                {errors.work && <span className="warning">{errors.work}</span>}
              </label>
        ...
        {step === 4 && (
          <div className="step active">
            ...
            <div className="form-group">
              <label>
                Select your goals{' '}
                {errors.goals && <span className="warning">{errors.goals}</span>}
              </label>
              <div className="checkbox-group">
                {[
                  'Subscription costs',
